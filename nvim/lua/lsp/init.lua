...
local on_attach = function(client, bufnr)
  ...
  vim.cmd("command! LspImplementations lua vim.lsp.buf.implementation()")
  vim.cmd("command! LspImplementationsFzf lua builtin.lsp_implementations()")
  ...
  buf_map(bufnr, "n", "<localleader>gi", ":LspImplementations<CR>", {silent = true})
  buf_map(bufnr, "n", "<localleader>gI", ":Telescope lsp_implementations<CR>", {silent = true})
